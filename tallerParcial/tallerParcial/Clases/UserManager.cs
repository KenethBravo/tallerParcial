...
namespace tallerParcial.Clases
{
    //using System.Net.Http; conexion al servidor
    //using Newtonsoft.Json; interprete archivos json
    class UserManager
    {
        ...
        public async Task<IEnumerable<User>> getUsuarios() { // IEnumerable permite visualizar una lista que contiene datos
